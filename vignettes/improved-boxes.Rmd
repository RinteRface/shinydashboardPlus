...
```{r socialBox, echo=FALSE, fig.cap='socialBox with userComments and attachmentBlock', fig.align = 'center', out.width='50%'}
knitr::include_graphics("figures/socialBox.png")
``` 
